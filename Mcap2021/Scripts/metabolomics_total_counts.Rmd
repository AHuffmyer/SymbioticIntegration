...
```{r}
hist(total_counts$total.ion.count)

total_counts$log.ion.counts<-log10(1+total_counts$total.ion.count)

hist(total_counts$log.ion.counts)
```
...
Overall, nitrogen and amino acid metablism are driving differences between high and ambient treatments. 
