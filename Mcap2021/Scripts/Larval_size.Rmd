...
size_plot_full<-size %>%
    ...
    xlab("Timepoint") + 
    ylab(expression(bold(paste("Larval Volume (mm"^3, ")"))))+
    geom_text(x=1.5, y=0.01, label="time p<0.001", color="black", size=4)+
    geom_text(x=1.5, y=0.0, label="treatment p=0.001", color="black", size=4)+
...
#Save plot
ggsave(size_plot_full, file="Mcap2021/Figures/size.png", w=3, h=5)
```
