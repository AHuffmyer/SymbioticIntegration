...
r_plot_size<-PRdata %>%
    ...
    geom_text(x=1.5, y=0.05, label="Temperature p=0.120", color="darkgray", size=6)+
...
p_plot_size<-PRdata %>%
    ...
    geom_text(x=1.5, y=0.10, label="Treatment p=0.620", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.05, label="Temperature p=0.334", color="darkgray", size=6)+
...
gp_size_plot<-PRdata %>%
    ...
    geom_text(x=1.5, y=0.12, label="Temperature p=0.089", color="darkgray", size=6)+
...
pr_size_plot<-PRdata %>%
    ...
    #scale_y_continuous(limits=c(0.8, 3), labels = scales::number_format(accuracy = 0.01, decimal.mark = '.'))+
    ylim(1, 2.8) +
    geom_text(x=1.5, y=1.2, label="Treatment p=0.054", color="darkgray", size=6)+
    geom_text(x=1.5, y=1.1, label="Temperature p=0.484", color="darkgray", size=6)+
