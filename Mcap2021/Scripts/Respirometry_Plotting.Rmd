...
r_plot_size<-PRdata %>%
    ...
    #scale_y_continuous(limits=c(0.5, -0.005), labels = scales::number_format(accuracy = 0.01, decimal.mark = '.'))+
    ylim(0, 0.6)+
    geom_text(x=1.5, y=0.07, label="Treatment p=0.342", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.01, label="Temperature p=0.187", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.04, label="Interaction p=0.199", color="darkgray", size=6)+
    theme_classic() + 
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=16),
...
p_plot_size<-PRdata %>%
    ...
    geom_text(x=1.5, y=0.07, label="Treatment p=0.391", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.01, label="Temperature p=0.260", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.04, label="Interaction p=0.403", color="darkgray", size=6)+
    ylim(0, 0.6) +
    theme_classic() + 
    theme(
      legend.position="none",
...
gp_size_plot<-PRdata %>%
    ...
    ylim(0, 0.6) +
    geom_text(x=1.5, y=0.07, label="Treatment p=0.857", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.01, label="Temperature p=0.130", color="darkgray", size=6)+
    geom_text(x=1.5, y=0.04, label="Interaction p=0.183", color="darkgray", size=6)+
    theme_classic() + 
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=16),
