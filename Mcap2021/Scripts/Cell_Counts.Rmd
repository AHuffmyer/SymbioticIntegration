...
symb_plot<-all %>%
    ...
    geom_boxplot(aes(color=Treatment), outlier.shape = NA, lwd=1, width=0.5) +
    geom_point(aes(fill=Treatment), pch = 21, size=4, position = position_jitterdodge(0.4), alpha=0.4) + 
    scale_fill_manual(values=c("blue", "red"))+
    scale_color_manual(values=c("blue", "red"))+
    xlab("") + 
    ylab(expression(bold(paste("Symbiont density (cells ug protein"^-1, ")"))))+
    geom_text(x=1.5, y=800, label="p=0.150", color="darkgray", size=4)+
    theme_classic() + 
...
ggsave("Mcap2021/Figures/symbiont_density.png", symb_plot, width=3, height=5)
```
