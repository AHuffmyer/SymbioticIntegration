...
ggsave("Mcap2021/Figures/Respiration/Respiration.png", r_plot, dpi=300, w=8.5, h=5, units="in")
```
...
ggsave(filename="Mcap2021/Figures/Respiration/respirometry_fig.png", plot=full_fig, dpi=500, width=26, height=6, units="in")
```
...
Rmodel1<-lmer(R.nmol.org.min~Treatment*Temperature + (1|Run), data=PRdata) #run as random
...
```{r, results=TRUE, warning=FALSE, message=FALSE}
Pmodel1<-lmer(P.nmol.org.min~Treatment*Temperature + (1|Run), data=PRdata) #run nested within day
...
```{r, results=TRUE, warning=FALSE, message=FALSE}
GPmodel1<-lmer(GP.nmol.org.min~Treatment*Temperature + (1|Run), data=PRdata) #run nested within day
...
```{r, results=TRUE, warning=FALSE, message=FALSE}
PRmodel1<-lmer(ratio~Treatment*Temperature + (1|Run), data=PRdata) #run as random
